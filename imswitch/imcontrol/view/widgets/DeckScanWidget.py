...
class DeckScanWidget(NapariHybridWidget):
    ...
    def init_scan_config_widget(self, options=(0, 0, 1, 1)):
        ...
        self.ScanValueRounds.setMaximum(10000)
        ...
        self.ScanValueTimePeriodHours.setMaximum(10000)
    ...
    def init_zstack_config_widget(self, options=(1, 0, 1, 4)):
        ...
        self.ScanValueNSlices.setMaximum(1000)
    ...
    def init_actions_widget(self, options = (4,0,1,1)):
        ...
        self.scan_list_actions_info.setMinimumHeight(40)
        ...
        self.ScanShowLastButton.setStyleSheet("font-size:14px")
        self.ScanShowLastButton.setFixedHeight(40)
        ...
        # self.ScanInfoStartTime.setMinimumHeight(40)
        ...
        self.ScanListActionsWidget.setSizePolicy(QtWidgets.QSizePolicy.Preferred,
                                                 QtWidgets.QSizePolicy.Expanding)
        self.ScanListActionsWidget.setMaximumHeight(160)
