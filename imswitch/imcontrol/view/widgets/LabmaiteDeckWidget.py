...
class LabmaiteDeckWidget(NapariHybridWidget):
    ...
    def init_experiment_buttons(self, options=(4, 4, 1, 1)):
        ...
        exp_buttons_layout.addWidget(self.adjust_all_focus_button, 3, 0, 1, 1)
